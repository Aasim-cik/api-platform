 ...
 * @ApiFilter(SearchFilter::class, properties={"title": "partial", "description": "partial", "owner.username": "partial"})
...
class CheeseListing
{
     ...
     * @Assert\NotBlank()
     * @Assert\Length(
     *     min="2", max="50", maxMessage="Describe your cheese in 50 chars or less"
     * )
     */
    private $title;
